          ...
          <div className="space-y-4 order-2 md:order-1">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-2xl bg-white text-black text-sm font-medium hover:bg-zinc-100 transition-colors"
              >
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center px-4 py-2.5 rounded-2xl bg-white text-black text-sm font-medium hover:bg-zinc-100 transition-colors"
              >
                View Website
              </a>
