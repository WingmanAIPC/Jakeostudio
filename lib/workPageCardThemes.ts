/**
 * Case study cards on /work — light branded surfaces + hover accents.
 */
...
export const WORK_PAGE_CARD_THEMES: Record<WorkCardThemeKey, WorkCardTheme> = {
  ...
  cloverleaf: {
    surface:
      "border-[#10A142]/55 bg-zinc-100 text-[#052e12] shadow-md shadow-black/10 transition-all duration-300 ease-out",
    surfaceHover:
    ...
    kicker: "text-[#0d7a32]",
    title: "text-[#052e12]",
    subtitle: "text-[#052e12]",
    body: "text-[#052e12]",
    tag: "border-[#10A142]/60 bg-white text-[#052e12]",
    cta:
      "border-2 border-[#10A142] bg-white text-[#052e12] shadow-[0_0_20px_-12px_rgba(16,161,66,0.35)] group-hover:bg-[#10A142] group-hover:border-[#10A142] group-hover:text-white",
  },
  biro: {
    surface:
      "border-slate-300/90 bg-zinc-100 text-slate-950 shadow-md shadow-black/10 transition-all duration-300 ease-out",
    surfaceHover:
    ...
    body: "text-slate-800",
    tag: "border-slate-300 bg-white text-slate-900",
    cta:
      "border-2 border-orange-500 bg-orange-100 text-orange-950 shadow-[0_0_20px_-12px_rgba(249,115,22,0.35)] group-hover:bg-orange-500 group-hover:border-orange-500 group-hover:text-white",
  },
};
